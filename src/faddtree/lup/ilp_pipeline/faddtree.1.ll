...
; <label>:54                                      ; preds = %1
  %.lcssa2 = phi i32 [ %53, %1 ]
  %.lcssa = phi float [ %52, %1 ]
  %55 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str1, i32 0, i32 0), i32 %.lcssa2) #2
  %56 = fpext float %.lcssa to double
  %57 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), double %56) #2
  %58 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str3, i32 0, i32 0), i32 %.lcssa2) #2
  %59 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([16 x i8]* @.str4, i32 0, i32 0), i32 1183703040) #2
  %60 = fadd float %.lcssa, -1.816000e+04
