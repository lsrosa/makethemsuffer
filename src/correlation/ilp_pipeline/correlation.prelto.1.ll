; ModuleID = 'correlation.prelto.1.bc'
...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #0 {
  ...
  call void @llvm.lifetime.start(i64 10000, i8* %1) #1
...
.preheader2:                                      ; preds = %30, %.preheader2.preheader
  %j.111 = phi i32 [ %37, %30 ], [ 0, %.preheader2.preheader ]
...
; <label>:30                                      ; preds = %20
  ...
  %33 = tail call i32 bitcast (i32 (...)* @sqrt to i32 (double)*)(double %32) #3
  %34 = sitofp i32 %33 to float
  %35 = fcmp ugt float %34, 0x3FB99999A0000000
  %36 = select i1 %35, float %34, float 1.000000e+00
  store float %36, float* %17, align 4, !tbaa !1
  %37 = add nsw i32 %j.111, 1
...
.preheader1:                                      ; preds = %53, %.preheader1.preheader
  %i.27 = phi i32 [ %54, %53 ], [ 0, %.preheader1.preheader ]
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str1, i32 0, i32 0)) #3
  %38 = mul nsw i32 %i.27, 50
  br label %39

; <label>:39                                      ; preds = %39, %.preheader1
  %j.26 = phi i32 [ 0, %.preheader1 ], [ %52, %39 ]
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str2, i32 0, i32 0)) #3
  %40 = getelementptr inbounds [50 x float]* %mean, i32 0, i32 %j.26
  %41 = load float* %40, align 4, !tbaa !1
  %42 = add nsw i32 %j.26, %38
  %43 = getelementptr inbounds [2500 x float]* %data, i32 0, i32 %42
  %44 = load float* %43, align 4, !tbaa !1
  %45 = fsub float %44, %41
  %46 = tail call i32 bitcast (i32 (...)* @sqrt to i32 (double)*)(double 0x3FF3333340000000) #3
  %47 = sitofp i32 %46 to float
  %48 = getelementptr inbounds [50 x float]* %stddev, i32 0, i32 %j.26
  %49 = load float* %48, align 4, !tbaa !1
  %50 = fmul float %47, %49
  %51 = fdiv float %45, %50
  store float %51, float* %43, align 4, !tbaa !1
  %52 = add nsw i32 %j.26, 1
  %exitcond18 = icmp eq i32 %j.26, 49
  br i1 %exitcond18, label %53, label %39

; <label>:53                                      ; preds = %39
  %54 = add nsw i32 %i.27, 1
  %exitcond19 = icmp eq i32 %i.27, 49
  br i1 %exitcond19, label %.loopexit.preheader, label %.preheader1

.loopexit.preheader:                              ; preds = %53
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.preheader
  call void @llvm.lifetime.end(i64 200, i8* %3) #1
  call void @llvm.lifetime.end(i64 200, i8* %2) #1
  call void @llvm.lifetime.end(i64 10000, i8* %1) #1
  ret i32 50
}
