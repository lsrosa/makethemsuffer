...
__global unsigned char JpegFileBuf[JPEG_FILE_SIZE];
...
__global int i_marker = 0;
__global const int out_unread_marker[READ_MARKERS_REP] =
  { 0xd8, 0xe0, 0xdb, 0xdb, 0xc0, 0xc4, 0xc4, 0xc4, 0xc4, 0xda };


#define GET_SOF_REP 3
__global int out_length_get_sof = 17;
__global int out_data_precision_get_sof = 8;
__global int out_p_jinfo_image_height_get_sof = 59;
__global int out_p_jinfo_image_width_get_sof = 90;
__global int out_p_jinfo_num_components_get_sof = 3;
__global const int out_index_get_sof[GET_SOF_REP] = { 0, 1, 2 };
__global const int out_id_get_sof[GET_SOF_REP] = { 1, 2, 3 };
__global const int out_h_samp_factor_get_sof[GET_SOF_REP] = { 2, 1, 1 };
__global const int out_v_samp_factor_get_sof[GET_SOF_REP] = { 2, 1, 1 };
__global const int out_quant_tbl_no_get_sof[GET_SOF_REP] = { 0, 1, 1 };

#define GET_SOS_REP 3
__global int i_get_sos = 0;
__global int out_length_get_sos = 12;
__global int out_num_comp_get_sos = 3;
__global const int out_comp_id_get_sos[GET_SOS_REP] = { 1, 2, 3 };
__global const int out_dc_tbl_no_get_sos[GET_SOS_REP] = { 0, 1, 1 };
__global const int out_ac_tbl_no_get_sos[GET_SOS_REP] = { 0, 1, 1 };

#define GET_DHT_REP 4
__global int i_get_dht = 0;
__global const int out_length_get_dht[GET_DHT_REP] = { 29, 179, 29, 179 };
__global const int out_index_get_dht[GET_DHT_REP] = { 0x0, 0x10, 0x1, 0x11 };
__global const int out_count_get_dht[GET_DHT_REP] = { 12, 162, 12, 162 };

#define GET_DQT_REP 2
int __constant i_get_dqt = 0;
__global const int out_length_get_dqt[GET_DQT_REP] = { 65, 65 };
__global const int out_prec_get_dht[GET_DQT_REP] = { 0, 0 };
__global const int out_num_get_dht[GET_DQT_REP] = { 0, 1 };

__global const int izigzag_index[64] = { 0, 1, 8, 16, 9, 2, 3, 10,
 ...
 unsigned char * channel ReadBuf;

/* Used for sign extensions. */
__global const  int extend_mask[20] = {
...
/* Masks */
__global const int bit_set_mask[32] = {	/* This is 2^i at ith position */
...
__global const int lmask[32] = {		/* This is 2^{i+1}-1 */
...
__global  unsigned int current_read_byte;
__global  int read_position = -1;

void ChenIDct (int *x, int *y);

__global int rgb_buf[4][RGB_NUM][DCTSIZE2];

__global const int zigzag_index[64] =	/* Is zig-zag map for matrix -> scan array */
{ 0, 1, 5, 6, 14, 15, 27, 28,
...
__kernel void jpeg_read (
    __global unsigned char * restrict read_buf
    ){
