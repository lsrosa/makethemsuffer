...
; <label>:1                                       ; preds = %1, %0
  ...
  %18 = sdiv i32 %16, %17, !legup.pipeline.start_time !18, !legup.pipeline.avail_time !19, !legup.pipeline.stage !20
  %19 = add nsw i32 %18, %sum.02, !legup.pipeline.start_time !21, !legup.pipeline.avail_time !21, !legup.pipeline.stage !22
  %20 = add nsw i32 %i.01, 1, !legup.pipeline.start_time !4, !legup.pipeline.avail_time !4, !legup.pipeline.stage !5
  %exitcond1 = icmp eq i32 %20, 99, !legup.pipeline.start_time !10, !legup.pipeline.avail_time !10, !legup.pipeline.stage !4
  br i1 %exitcond1, label %21, label %1, !legup.pipelined !4, !legup.II !10, !legup.totalTime !23, !legup.maxStage !22, !legup.tripCount !24, !legup.label !25, !legup.pipeline.start_time !10, !legup.pipeline.avail_time !10, !legup.pipeline.stage !4
...
!2 = metadata !{metadata !"102"}
!3 = metadata !{metadata !"51"}
...
!18 = metadata !{metadata !"71"}
!19 = metadata !{metadata !"103"}
!20 = metadata !{metadata !"35"}
!21 = metadata !{metadata !"104"}
!22 = metadata !{metadata !"52"}
!23 = metadata !{metadata !"105"}
!24 = metadata !{metadata !"99"}
!25 = metadata !{metadata !"loop0"}
