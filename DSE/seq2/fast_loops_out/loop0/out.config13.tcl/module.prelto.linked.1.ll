...
; <label>:1                                       ; preds = %1, %0
  %sum.02 = phi i32 [ 0, %0 ], [ %28, %1 ]
  %i.01 = phi i32 [ 0, %0 ], [ %29, %1 ]
  ...
  %27 = sdiv i32 %24, %26
  %28 = add nsw i32 %27, %sum.02
  %29 = add nsw i32 %i.01, 1
  %exitcond = icmp eq i32 %29, 99
  br i1 %exitcond, label %30, label %1

; <label>:30                                      ; preds = %1
  %.lcssa = phi i32 [ %28, %1 ]
  %31 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str1, i32 0, i32 0), i32 %.lcssa) #2
  %32 = icmp eq i32 %.lcssa, 250102
  br i1 %32, label %33, label %35

; <label>:33                                      ; preds = %30
  %34 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0)) #2
  br label %37

; <label>:35                                      ; preds = %30
  %36 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0)) #2
  br label %37
