...
reg [31:0] main_1_sum02_reg_stage4;
...
always @(*) begin
	...
	start_time: 9 avail_time: 9 stage: 3 II: 3 start_ii_state = 9 % 3 = 0 avail_ii_state = 9 % 3 = 0*/
...
always @(posedge clk) begin
	...
	start_time: 6 avail_time: 7 stage: 2 II: 3 start_ii_state = 6 % 3 = 0 avail_ii_state = 7 % 3 = 1*/
	if ((~(memory_controller_waitrequest) & ((loop0_1_ii_state == 2'd1) & loop0_1_valid_bit_7))) begin
...
always @(posedge clk) begin
	...
	start_time: 7 avail_time: 8 stage: 2 II: 3 start_ii_state = 7 % 3 = 1 avail_ii_state = 8 % 3 = 2*/
	if ((~(memory_controller_waitrequest) & ((loop0_1_ii_state == 2'd2) & loop0_1_valid_bit_8))) begin
...
always @(posedge clk) begin
	...
	start_time: 8 avail_time: 9 stage: 2 II: 3 start_ii_state = 8 % 3 = 2 avail_ii_state = 9 % 3 = 0*/
	if ((~(memory_controller_waitrequest) & ((loop0_1_ii_state == 2'd0) & loop0_1_valid_bit_9))) begin
...
always @(posedge clk) begin
	...
	start_time: 9 avail_time: 10 stage: 3 II: 3 start_ii_state = 9 % 3 = 0 avail_ii_state = 10 % 3 = 1*/
	if ((~(memory_controller_waitrequest) & ((loop0_1_ii_state == 2'd1) & loop0_1_valid_bit_10))) begin
...
always @(posedge clk) begin
	...
	start_time: 10 avail_time: 11 stage: 3 II: 3 start_ii_state = 10 % 3 = 1 avail_ii_state = 11 % 3 = 2*/
	if ((~(memory_controller_waitrequest) & ((loop0_1_ii_state == 2'd2) & loop0_1_valid_bit_11))) begin
...
always @(posedge clk) begin
	...
	start_time: 11 avail_time: 12 stage: 3 II: 3 start_ii_state = 11 % 3 = 2 avail_ii_state = 12 % 3 = 0*/
...
always @(*) begin
	...
	start_time: 12 avail_time: 12 stage: 4 II: 3 start_ii_state = 12 % 3 = 0 avail_ii_state = 12 % 3 = 0*/
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop0_1_ii_state == 2'd0) & loop0_1_valid_bit_9))) begin
		main_1_sum02_reg_stage3 <= main_1_sum02;
		if (start == 1'b0 && ^(main_1_sum02) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_sum02_reg_stage3"); $finish; end
	end
end
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop0_1_ii_state == 2'd2) & loop0_1_valid_bit_11))) begin
		main_1_sum02_reg_stage4 <= main_1_sum02_reg_stage3;
		if (start == 1'b0 && ^(main_1_sum02_reg_stage3) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_sum02_reg_stage4"); $finish; end
	end
end
always @(posedge clk) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_1_14_en == 1'd1)) begin
		main_1_14_stage0_reg <= (main_1_12 * main_1_13_reg_stage2);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_1_16_en == 1'd1)) begin
		main_1_16_stage0_reg <= (main_1_14 * main_1_15_reg_stage2);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_1_20_en == 1'd1)) begin
		main_1_20_stage0_reg <= (main_1_18 * main_1_19_reg_stage3);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_1_22_en == 1'd1)) begin
		main_1_22_stage0_reg <= (main_1_20 * main_1_21_reg_stage3);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_1_24_en == 1'd1)) begin
		main_1_24_stage0_reg <= (main_1_22 * main_1_23_reg_stage3);
	end
end
always @(posedge clk) begin
