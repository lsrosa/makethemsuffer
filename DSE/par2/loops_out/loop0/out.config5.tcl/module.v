...
always @(posedge clk) begin
	/* main: %1*/
	/*   %25 = sdiv i32 %23, %24, !legup.pipeline.start_time !9, !legup.pipeline.avail_time !13, !legup.pipeline.stage !2
...
always @(posedge clk) begin
	/* main: %1*/
	/*   %28 = sdiv i32 %26, %27, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !11, !legup.pipeline.stage !3
...
always @(*) begin
	r3_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %10, i32* %scevgep19, align 4, !tbaa !4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !3
	start_time: 2 avail_time: 3 stage: 0 II: 3 start_ii_state = 2 % 3 = 2 avail_ii_state = 3 % 3 = 0*/
	if (((loop0_1_ii_state == 2'd2) & loop0_1_valid_bit_2)) begin
		r3_address_a = (main_1_scevgep19_reg_stage0 >>> 3'd2);
	end
end
always @(*) begin
...
always @(*) begin
	r8_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %25, i32* %scevgep4, align 4, !tbaa !4, !legup.pipeline.start_time !14, !legup.pipeline.avail_time !15, !legup.pipeline.stage !16
...
always @(*) begin
	r9_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %28, i32* %scevgep, align 4, !tbaa !4, !legup.pipeline.start_time !14, !legup.pipeline.avail_time !15, !legup.pipeline.stage !16
	start_time: 36 avail_time: 37 stage: 12 II: 3 start_ii_state = 36 % 3 = 0 avail_ii_state = 37 % 3 = 1*/
	if (((loop0_1_ii_state == 2'd0) & loop0_1_valid_bit_36)) begin
