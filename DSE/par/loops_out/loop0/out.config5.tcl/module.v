...
always @(*) begin
	r1_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %4, i32* %scevgep16, align 4, !tbaa !4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !8
	...
	if (((loop0_1_ii_state == 1'd0) & loop0_1_valid_bit_2)) begin
		r1_address_a = (main_1_scevgep16_reg_stage2 >>> 3'd2);
	end
end
always @(*) begin
...
always @(*) begin
	r2_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %7, i32* %scevgep13, align 4, !tbaa !4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !8
	start_time: 2 avail_time: 3 stage: 2 II: 1 start_ii_state = 2 % 1 = 0 avail_ii_state = 3 % 1 = 0*/
	if (((loop0_1_ii_state == 1'd0) & loop0_1_valid_bit_2)) begin
		r2_address_a = (main_1_scevgep13_reg_stage2 >>> 3'd2);
	end
end
always @(*) begin
...
always @(*) begin
	r3_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %10, i32* %scevgep10, align 4, !tbaa !4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !8
	start_time: 2 avail_time: 3 stage: 2 II: 1 start_ii_state = 2 % 1 = 0 avail_ii_state = 3 % 1 = 0*/
	if (((loop0_1_ii_state == 1'd0) & loop0_1_valid_bit_2)) begin
		r3_address_a = (main_1_scevgep10_reg_stage2 >>> 3'd2);
	end
end
always @(*) begin
...
always @(*) begin
	r4_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %13, i32* %scevgep7, align 4, !tbaa !4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !8
	start_time: 2 avail_time: 3 stage: 2 II: 1 start_ii_state = 2 % 1 = 0 avail_ii_state = 3 % 1 = 0*/
	if (((loop0_1_ii_state == 1'd0) & loop0_1_valid_bit_2)) begin
		r4_address_a = (main_1_scevgep7_reg_stage2 >>> 3'd2);
	end
end
always @(*) begin
...
always @(*) begin
	r5_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %16, i32* %scevgep4, align 4, !tbaa !4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !8
	start_time: 2 avail_time: 3 stage: 2 II: 1 start_ii_state = 2 % 1 = 0 avail_ii_state = 3 % 1 = 0*/
	if (((loop0_1_ii_state == 1'd0) & loop0_1_valid_bit_2)) begin
		r5_address_a = (main_1_scevgep4_reg_stage2 >>> 3'd2);
	end
end
always @(*) begin
...
always @(*) begin
	r6_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %19, i32* %scevgep, align 4, !tbaa !4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !8
	start_time: 2 avail_time: 3 stage: 2 II: 1 start_ii_state = 2 % 1 = 0 avail_ii_state = 3 % 1 = 0*/
	if (((loop0_1_ii_state == 1'd0) & loop0_1_valid_bit_2)) begin
		r6_address_a = (main_1_scevgep_reg_stage2 >>> 3'd2);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop0_1_epilogue & (~(loop0_1_valid_bit_2) & loop0_1_valid_bit_3)))) begin
		loop0_1_started <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop0_1_started"); $finish; end
	end
end
...
always @(*) begin
	loop0_1_pipeline_finish = ((memory_controller_waitrequest == 1'd0) & (loop0_1_epilogue & (~(loop0_1_valid_bit_2) & loop0_1_valid_bit_3)));
end
always @(*) begin
