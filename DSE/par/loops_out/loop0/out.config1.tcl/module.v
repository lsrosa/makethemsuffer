...
always @(posedge clk) begin
	/* main: %1*/
	/*   %10 = mul nsw i32 %9, %8, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !8, !legup.pipeline.stage !3
...
always @(posedge clk) begin
	/* main: %1*/
	/*   %13 = mul nsw i32 %12, %11, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !8, !legup.pipeline.stage !3
	start_time: 2 avail_time: 3 stage: 0 II: 3 start_ii_state = 2 % 3 = 2 avail_ii_state = 3 % 3 = 0*/
	if ((~(memory_controller_waitrequest) & ((loop0_1_ii_state == 2'd0) & loop0_1_valid_bit_3))) begin
...
always @(posedge clk) begin
	/* main: %1*/
	/*   %16 = mul nsw i32 %15, %14, !legup.pipeline.start_time !2, !legup.pipeline.avail_time !12, !legup.pipeline.stage !3
...
always @(posedge clk) begin
	/* main: %1*/
	/*   %19 = mul nsw i32 %18, %17, !legup.pipeline.start_time !2, !legup.pipeline.avail_time !12, !legup.pipeline.stage !3
	start_time: 1 avail_time: 2 stage: 0 II: 3 start_ii_state = 1 % 3 = 1 avail_ii_state = 2 % 3 = 2*/
	if ((~(memory_controller_waitrequest) & ((loop0_1_ii_state == 2'd2) & loop0_1_valid_bit_2))) begin
...
always @(*) begin
	r5_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %16, i32* %scevgep4, align 4, !tbaa !4, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !8, !legup.pipeline.stage !3
	start_time: 2 avail_time: 3 stage: 0 II: 3 start_ii_state = 2 % 3 = 2 avail_ii_state = 3 % 3 = 0*/
	if (((loop0_1_ii_state == 2'd2) & loop0_1_valid_bit_2)) begin
		r5_address_a = (main_1_scevgep4_reg_stage0 >>> 3'd2);
	end
end
always @(*) begin
...
always @(*) begin
	r6_address_a = 1'd0;
	/* main: %1*/
	/*   store volatile i32 %19, i32* %scevgep, align 4, !tbaa !4, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !8, !legup.pipeline.stage !3
	start_time: 2 avail_time: 3 stage: 0 II: 3 start_ii_state = 2 % 3 = 2 avail_ii_state = 3 % 3 = 0*/
	if (((loop0_1_ii_state == 2'd2) & loop0_1_valid_bit_2)) begin
...
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop0_1_epilogue & (~(loop0_1_valid_bit_5) & loop0_1_valid_bit_6)))) begin
		loop0_1_started <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop0_1_started"); $finish; end
	end
end
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop0_1_ii_state == 2'd2) & loop0_1_valid_bit_2))) begin
		main_1_6_reg_stage1 <= main_1_6_reg_stage0;
		if (start == 1'b0 && ^(main_1_6_reg_stage0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_6_reg_stage1"); $finish; end
	end
end
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop0_1_ii_state == 2'd1) & loop0_1_valid_bit_4))) begin
...
always @(*) begin
	loop0_1_pipeline_finish = ((memory_controller_waitrequest == 1'd0) & (loop0_1_epilogue & (~(loop0_1_valid_bit_5) & loop0_1_valid_bit_6)));
end
always @(*) begin
