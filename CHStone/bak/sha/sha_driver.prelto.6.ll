; ModuleID = 'sha_driver.prelto.6.bc'
...
sha_final.exit:                                   ; preds = %while.body4.i22.i
  ...
  %call = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str2, i32 0, i32 0), i32 %add.4) #3
  %cmp3 = icmp eq i32 %add.4, 5
  br i1 %cmp3, label %if.then, label %if.else

if.then:                                          ; preds = %sha_final.exit
  %call5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str3, i32 0, i32 0)) #3
  br label %if.end

if.else:                                          ; preds = %sha_final.exit
  %call6 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str4, i32 0, i32 0)) #3
  br label %if.end
...
entry:
  ...
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str5, i32 0, i32 0)) #3
...
for.body4:                                        ; preds = %for.body4.for.body4_crit_edge, %entry
  ...
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str6, i32 0, i32 0)) #3
...
for.body20:                                       ; preds = %for.body20, %for.end17
  ...
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str7, i32 0, i32 0)) #3
...
for.body35:                                       ; preds = %for.body35, %for.body20
  ...
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str8, i32 0, i32 0)) #3
...
for.body54:                                       ; preds = %for.body54, %for.body35
  ...
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str9, i32 0, i32 0)) #3
...
for.body76:                                       ; preds = %for.body76, %for.body54
  ...
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str10, i32 0, i32 0)) #3
