...
for.end17:                                        ; preds = %for.body4
  %20 = load i32* @sha_info_digest.0, align 4, !tbaa !1
  %21 = load i32* @sha_info_digest.1, align 4, !tbaa !1
  %22 = load i32* @sha_info_digest.2, align 4, !tbaa !1
  %23 = load i32* @sha_info_digest.3, align 4, !tbaa !1
  %24 = load i32* @sha_info_digest.4, align 4, !tbaa !1
  br label %for.body20

for.body20:                                       ; preds = %for.body20, %for.end17
  %E.0195 = phi i32 [ %24, %for.end17 ], [ %D.0194, %for.body20 ]
  %D.0194 = phi i32 [ %23, %for.end17 ], [ %C.0193, %for.body20 ]
  %C.0193 = phi i32 [ %22, %for.end17 ], [ %or29, %for.body20 ]
  %B.0192 = phi i32 [ %21, %for.end17 ], [ %A.0191, %for.body20 ]
  %A.0191 = phi i32 [ %20, %for.end17 ], [ %add26, %for.body20 ]
  %i.2190 = phi i32 [ 0, %for.end17 ], [ %inc31, %for.body20 ]
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str7, i32 0, i32 0)) #2
...
for.body35:                                       ; preds = %for.body35, %for.body20
  ...
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str8, i32 0, i32 0)) #2
...
for.body54:                                       ; preds = %for.body54, %for.body35
  ...
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str9, i32 0, i32 0)) #2
...
for.body76:                                       ; preds = %for.body76, %for.body54
  ...
  tail call void @__legup_label(i8* getelementptr inbounds ([6 x i8]* @.str10, i32 0, i32 0)) #2
  ...
  %28 = load i32* %arrayidx84, align 4, !tbaa !1
...
for.end92:                                        ; preds = %for.body76
  ...
  %29 = load i32* @sha_info_digest.0, align 4, !tbaa !1
  %add93 = add i32 %29, %add86.lcssa
  store i32 %add93, i32* @sha_info_digest.0, align 4, !tbaa !1
  %30 = load i32* @sha_info_digest.1, align 4, !tbaa !1
  %add94 = add i32 %30, %A.3173.lcssa
  store i32 %add94, i32* @sha_info_digest.1, align 4, !tbaa !1
  %31 = load i32* @sha_info_digest.2, align 4, !tbaa !1
  %add95 = add i32 %31, %or89.lcssa
  store i32 %add95, i32* @sha_info_digest.2, align 4, !tbaa !1
  %32 = load i32* @sha_info_digest.3, align 4, !tbaa !1
  %add96 = add i32 %32, %C.3175.lcssa
  store i32 %add96, i32* @sha_info_digest.3, align 4, !tbaa !1
  %33 = load i32* @sha_info_digest.4, align 4, !tbaa !1
  %add97 = add i32 %33, %D.3176.lcssa
